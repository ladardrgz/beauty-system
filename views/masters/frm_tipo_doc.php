<style>
    ...
    */
    ...
    /* ✅ empuja el botón a la derecha sin romper el espacio */
    ...
    /* Encabezado */
    #tablaTiposDocumento thead {
        background-color: #7a1c4b;
        color: #fff;
    }

    #tablaTiposDocumento th {
        padding: 14px 15px;
        text-align: left;
        font-weight: 600;
        font-size: 14px;
    ...
    #tablaTiposDocumento th:last-child {
        text-align: center;
    }

    /* Celdas */
    #tablaTiposDocumento td {
        padding: 12px 15px;
        vertical-align: middle;
        font-size: 15px;
    }

    #tablaTiposDocumento td.acciones {
        text-align: center;
    }

    /* Filas */
    #tablaTiposDocumento tbody tr {
        border-bottom: 1px solid #f0c8d8;
        transition: background-color 0.2s ease;
    }

    #tablaTiposDocumento tbody tr:hover {
...
<div class="contenedor-tipos-documento">
    <h2>Tipos de documento</h2>

    <div class="buscador">
        <input type="text" id="buscar" placeholder="Buscar tipo de documento...">
        <select id="ordenar">
        ...
        <button id="btnNuevo" class="btn-primario">
            <img src="assets/images/icons/add.png" alt="Nuevo" class="icono-btn"> Nuevo tipo
        </button>
    </div>

    <table id="tablaTiposDocumento">
        <thead>
            <tr>
...
<div id="modalNuevoTipo" class="modal">
    <div class="modal-content">
        ...
        <form id="formNuevoTipo" novalidate>
            ...
            <input type="text" id="nombre_tipo_documento" name="nombre_tipo_documento" required>
...
<div id="modalEditarTipo" class="modal">
    <div class="modal-content">
        ...
        <form id="formEditarTipo" novalidate>
            <input type="hidden" id="editar_id_tipo_documento">
            <label for="editar_nombre_tipo_documento">Nombre</label>
            <input type="text" id="editar_nombre_tipo_documento" required>
...
<script type="module" src="assets/js/tipo_documento.js"></script>
