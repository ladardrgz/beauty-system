<style>
    ...
    */
    ...
    #tablaGeneros td.acciones {
        text-align: center;
    }

    /* Filas */
    #tablaGeneros tbody tr {
        border-bottom: 1px solid #f0c8d8;
        transition: background-color 0.2s ease;
    }

    #tablaGeneros tbody tr:hover {
...
<div class="contenedor-generos">
    ...
    <div class="buscador">
        <input type="text" id="buscar" placeholder="Buscar género...">
        <select id="ordenar">
        ...
        <button id="btnNuevo" class="btn-primario">
            <img src="assets/images/icons/add.png" alt="Nuevo" class="icono-btn"> Nuevo género
        </button>
    </div>
...
<div id="modalEditarGenero" class="modal">
    <div class="modal-content">
        ...
        <form id="formEditarGenero">
            <input type="hidden" id="editar_id_genero">
            <label for="editar_nombre_genero">Nombre</label>
            <input type="text" id="editar_nombre_genero" required>
...
<script type="module" src="assets/js/genero.js"></script>