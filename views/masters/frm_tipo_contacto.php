...
#tablaTiposContacto thead {
    background-color: #7a1c4b;
    color: #fff;
}

#tablaTiposContacto th, #tablaTiposContacto td {
    padding: 12px 15px;
    font-size: 15px;
}

#tablaTiposContacto th:last-child, #tablaTiposContacto td.acciones {
    text-align: center;
}

#tablaTiposContacto tbody tr {
    border-bottom: 1px solid #f0c8d8;
    transition: background-color 0.2s ease;
}

#tablaTiposContacto tbody tr:hover {
...
<div class="contenedor-tipos-contacto">
    <h2>Tipos de contacto</h2>

    <div class="buscador">
        <input type="text" id="buscar" placeholder="Buscar tipo de contacto...">
        <select id="ordenar">
        ...
        <button id="btnNuevo" class="btn-primario">
            <img src="assets/images/icons/add.png" alt="Nuevo" class="icono-btn"> Nuevo tipo de contacto
        </button>
    </div>

    <table id="tablaTiposContacto">
        <thead>
            <tr>
...
<div id="modalNuevoTipo" class="modal">
    <div class="modal-content">
        ...
        <form id="formNuevoTipo" novalidate>
            <label for="nombre_tipo_contacto">Nombre</label>
            <input type="text" id="nombre_tipo_contacto" name="nombre_tipo_contacto" required>
...
<div id="modalEditarTipo" class="modal">
    <div class="modal-content">
        <h3>Editar tipo de contacto</h3>
        <form id="formEditarTipo" novalidate>
            <input type="hidden" id="editar_id_tipo_contacto">
            <label for="editar_nombre_tipo_contacto">Nombre</label>
            <input type="text" id="editar_nombre_tipo_contacto" required>
...
<script type="module" src="assets/js/tipo_contacto.js"></script>
