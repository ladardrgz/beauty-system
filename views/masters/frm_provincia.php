<style>
    ...
    */
    ...
    #tablaProvincias td.acciones {
        text-align: center;
    }

    /* Filas */
    #tablaProvincias tbody tr {
        border-bottom: 1px solid #f0c8d8;
        transition: background-color 0.2s ease;
    }

    #tablaProvincias tbody tr:hover {
...
<div class="contenedor-provincias">
    ...
    <div class="buscador">
        <div style="display: flex; align-items: center; gap: 8px;">
            <input type="text" id="buscar" placeholder="Buscar provincia...">
            <select id="ordenar">
    ...
    <div id="modalNuevaProvincia" class="modal">
        <div class="modal-content">
            <h3>Nueva provincia</h3>
            <form id="formNuevaProvincia" novalidate>
                <label for="nombre_provincia">Nombre</label>
                <input type="text" id="nombre_provincia" name="nombre_provincia" maxlength="50" required>
    ...
    <div id="modalEditarProvincia" class="modal">
        <div class="modal-content">
            <h3>Editar provincia</h3>
            <form id="formEditarProvincia" novalidate>
                <input type="hidden" id="editar_id_provincia" name="editar_id_provincia">

                <label for="editar_nombre_provincia">Nombre</label>
                <input type="text" id="editar_nombre_provincia" name="editar_nombre_provincia" maxlength="50" required>

                <label for="editar_id_pais">País</label>
                <select id="editar_id_pais" name="editar_id_pais" required>
                    <option value="">Seleccione un país</option>
                </select>
...
<!-- Script principal -->
<script type="module" src="assets/js/provincias.js"></script>
